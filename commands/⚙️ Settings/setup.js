...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    try {
      ...
      message.guild.channels.create("Bot_Music-Requests", {
          type: 'category',
                  ...
                  message.guild.channels.create(`🎵｜requests`, {
                    ...
                    .then(async (channel3) => {
                      ...
                      let embed1 = new MessageEmbed()
                        ...
                        .setTitle("Bot_Music | Request | Guide")
                      ...
                      let embed2 = new MessageEmbed()
                        .setColor(ee.color)
                        .setFooter(ee.footertext, ee.footericon)
                        .setTitle("Bot_Music | Music Queue")
                        .setDescription(`Empty\nJoin a voice channel and queue songs by name or url in here.`)
                      let embed3 = new MessageEmbed()
                        .setColor(ee.color)
                        .setFooter(ee.footertext, ee.footericon)
                        .setTitle("Bot_Music | Currently no song is playing!")
                        .setDescription(`Join a voice channel and enter a song name or url to play.\n[Invite Bot_Music](https://discord.com/api/oauth2/authorize?client_id=855662770757435422&permissions=8&scope=bot) • [Support Server](https://discord.gg/5hP6bCa3eb)`)
                        .setImage("https://cdn.discordapp.com/attachments/845110987173658685/862880877695336488/standard_13.gif")
                      //send a temp message
